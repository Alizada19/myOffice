	...
	?>
		<tr>
			...
			<td style="width:8%;padding-left:5px;background-color:#b3d7ff87;">
				<a style="test-decoration: none;" title="View Record" href="<?=base_url('codeigniter/public/expenses/groupeView/')?><?=$row->Id?>/2" target="_blank">View</a>
				<a style="test-decoration: none;" title="Edit Record" href="<?=base_url('codeigniter/public/expenses/groupeEditView/')?><?=$row->Id?>" target="_blank">Edit</a>
			</td>
		</tr>
