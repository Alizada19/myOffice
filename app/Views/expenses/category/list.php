	...
	?>
		<tr>
			...
			<td style="width:8%;padding-left:5px;background-color:#b3d7ff87;">
				<a style="test-decoration: none;" title="View Record" href="<?=base_url('codeigniter/public/expenses/categoryView/')?><?=$row->Id?>/2" target="_blank">View</a>
				<a style="test-decoration: none;" title="Edit Record" href="<?=base_url('codeigniter/public/expenses/categoryEditView/')?><?=$row->Id?>" target="_blank">Edit</a>
			</td>
		</tr>
