<table style="width:100%;font-size:20px;float:left;margin-top:10px;margin-bottom:10px;">
	<tr>
	 <th colspan="2" style="width:100%;background-color:#b3d7ff87;text-align:center;">Credit</th>
	</tr>
	<!--<tr>
		<td colspan="4" style="width:100%;background-color:#b3d7ff87;">
			<select  style="background-color:#b3d7ff87;width:100%;font-size:20px;"  id="oc" name="oc"  tabindex="1005" required>
				<option value="">Select type</option>
				<option value="1">OT(Online Transfer)</option>				
	...
	<tr>
	 ...
	 <td colspan="3" style="width:26%;"><input class="form-control line" style="font-weight:bold;font-size:30px;" name="invDate" id="invDate" type="date" onblur="makeCapital(this.value,'ddate')" /></td>
	</tr>
	<tr>
