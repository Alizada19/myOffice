<form id="form1" method="post" action="<?=base_url('codeigniter/public/')?>saveChequeUpdate/<?=$query->Id?>">
		...
		<table class="table table-bordered table-striped custom-table">
			...
			<tbody>
				...
				<tr>
					<td>Cheque No:</td>
					<td colspan="3">
						<input class="form-control form-control-sm" name="cno" id="cno" type="text" placeholder="No" value="<?=$query->cno?>" required />
					</td>
				</tr>
				<tr>
					<td>Amount:</td>
					<td colspan="3">
						<input class="form-control form-control-sm" name="amount" id="amount" type="text" placeholder="RM 0" value="<?=$query->amount?>" required />
					</td>
				</tr>
				<tr>
					<td colspan="4">
