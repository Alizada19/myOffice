...
<div style="margin-left:1%;">
	...
	<div>
		<input type="date" name="edate" id="edate" value="<?=$edate?>" style="width:20%; height:30px;	text-align:center;">
	</div>
	...
	<div style="margin-bottom:5px;">
		<input type="submit" name="form1"   style="width:100px;" class="btn btn-primary line" id="search" value="Search" onclick="submitForm('<?=base_url('codeigniter/public/bringCustomers')?>')" />
	</div>
</div>
</form>
<div id="mainDive">
<div style="width:98%; margin-right:1%; margin-left:1%;">	
	...
	<div class="row" style="margin:15px 15px 15px 1%;;width:40%;">	
	   <input type="button" value="Generate Excel" name="btn_result" onclick="submitForm('<?=base_url('codeigniter/public/customerExcel')?>')" style="width:200px;" class="btn btn-primary line"></button>
	</div>
</div>
</div>
<script>
