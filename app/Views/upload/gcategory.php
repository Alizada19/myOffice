<div style="margin-top: 10%;">
	...
	<div style="width:98%; margin-right:1%; margin-left:1%;">	
		...
		<div>
			<input type="submit" value="Export PDF" name="btn_result" onclick="submitForm('<?=base_url('codeigniter/public/printCategory')?>')" style="width:100px;" class="btn btn-primary line"></button>
		</div>
	</div>
	</div>
</div>
