...
class Inoutchart extends BaseController
{
    //my constructor
	...
	public function index(): string
    {
		...
		$parchase = $this->DailyModel->parchase();
		...
		//echo "<pre />"; print_r($parchase); exit;
		$data['pChequeCharts'] = $parchase;
		$data['aweek'] = $aweek;
        return view('charts/inout', $data);
    }
