...
class Nightlyreport extends BaseController
{
    //my constructor
    ...
    {   
		...
		$data['tamay'] = $this->DailyModel->tamayn();			
		$data['bergaya'] = $this->DailyModel->bergayan();			
		$data['eden'] = $this->DailyModel->edenn();			
		$data['edensi'] = $this->DailyModel->edensin();			
		$data['edensw'] = $this->DailyModel->edenswn();			
		$data['edenjo'] = $this->DailyModel->edenjon();			
		//$data['edenjo2'] = $this->DailyModel->edenjon2();			
		$data['edena'] = $this->DailyModel->edenan();			
		$data['allshops'] = $this->DailyModel->allshopsn();
		
		return view('nightlyreport/home', $data);
    }
